...
public class Tablero extends JPanel {
    ...
    String fileName = "C:\\TEMP\\ErickaValeriaAliagaTaborga.txt";
        ...
        try {
            ...
            while ((st = br.readLine()) != null){
                ...
                if (st.endsWith("1")) {
                    ...
                    int xpart1 = Integer.valueOf(agparts[0])-1;
                    int ypart2 = Integer.valueOf(agparts[1])-1;
                    int zpart3 = Integer.valueOf(agparts[2])-1;
                    ...
                    g2.fillOval(10,posYAg,w,h);

                } else if (st.endsWith("2")) {
                    System.out.println("SOY UNA META");

                    String[] metparts = st.split(",");
                    int xmet = Integer.valueOf(metparts[0])-1;
                    int ymet = Integer.valueOf(metparts[1])-1;
                    int zmet = Integer.valueOf(metparts[2])-1;
        ...
        try {
            ...
            while ((st = br.readLine()) != null){
                ...
                if(st.endsWith("0")){
                    ...
                    int obsx = Integer.valueOf(partsobs[0])-1;
                    int obsy = Integer.valueOf(partsobs[1])-1;
